...
[recipe]
  ...
  description = 'A rich and creamy bowl of spicy aubergine goodness'
  yield = 'Serves 2-3'
  totalTime = '90 mins'
  difficulty = 'easy'
...
On the whole, this is an easy and healthy recipe. As in the case of other curries, it actually improves with time and I can guarantee that any leftovers are much better the next day! :)  This recipe can be served with a side of rice and/or [naan bread](/recipes/red-lentil-curry-homemade-naan-bread/).
