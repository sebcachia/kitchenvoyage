+++
title = 'Red Lentil Curry and Homemade Naan Bread'
date = '2017-06-29'
author = 'Marica'
...
[recipe]
  ...
  description = 'An aromatic dish full of flavour inspired by Indian cuisine.'
  yield = 'Serves 4'
  totalTime = '1hr'
  difficulty = 'easy'
...
[recipe title="Naan Bread" servings="4" time="30mins" difficulty="easy" image="http://www.kitchenvoyage.com/wp-content/uploads/2017/06/naanbread.jpg" description="A side dish to your Indian curries."]
[recipe-ingredients]
- 225g flour
- 2 tsp sugar
- 1 tsp salt
...
2. Create a well in the middle and pour in the milk and the oil. Combine everything together until it forms a ball. Knead the dough for about 5-10 minutes until it is very smooth and elastic.
3. Let the dough rest for at least 15 minutes. Divide into 8 equal pieces.
4. Heat the pan over medium-high heat. Roll out each piece of dough until very thin - almost see through. Liberally brush one side with melted butter.
5. Place the rolled out dough in your hot pan butter side down and cover it with a lid. Cook the naan bread for 1-2 minutes on each side. Continue to do so with your remaining dough.
6. Place them in a plate/basket, preferably covered with a cloth and serve them warm.
[/recipe-directions]
[/recipe]
