...
[recipe]
  ...
  description = 'A creamy, easy-to-make classic hummus'
  ...
  instructions = [
    'In a food processor, add all ingredients and puree until smooth in consistency.',
    'Taste for seasoning and adjust accordingly.',
    'As a dip: Serve it with carrot sticks, celery sticks, bell pepper strips, crackers or bread!',
    'As a spread: Spread it on your favourite bread and top it up with fresh tomatoes, crumbled feta cheese or roasted vegetables.',
    'As a light meal: Serve it as a side to grilled vegetables and a sunny side up egg.'
  ]
+++

Dinners, picnics, BBQs, drinks... all start with some nibbles or appetisers :D Dips are perfect for any occasion and can be shared with everyone. 
