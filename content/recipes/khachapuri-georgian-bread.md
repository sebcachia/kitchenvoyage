+++
title = 'Khachapuri - Georgian Bread'
date = '2018-03-08'
author = 'Marica'
...
[recipe]
  ...
  description = 'A boat-ful of deliciousness'
  yield = 'Serves 4-6'
  totalTime = '2hrs'
  difficulty = 'easy'
  ...
  instructions = [
    '*For the dough:* In a large mixing bowl, combine all the ingredients together and lightly need until no dry patches are visible. Cover with plastic wrap and set it aside for at lease one hour at room temperature or overnight in the refrigerator.',
    '*For the filling:* In a bowl, mix all cheeses together and season with salt and pepper.',
    'Preheat the oven to the highest temperature possible and heat 2 baking sheets. If you have a pizza stone, it is ideal to bake the khachapuri on it.',
    'Divide the dough into 4 equal pieces. Flour your surface and roll out each piece into a circular shape.',
    'Divide the filling among the 4 pieces of dough and spread it over leaving at least 1cm from the edge.',
    'Lightly brush the edges with a little bit of water.',
    'Bring the sides of the dough together in the middle over the topping and pleat both sides together. Then flatten it and flip the dough over so the seam is at the bottom.',
    'Using a sharp knife, slash along the length of the dough and push the dough to the side to create a rim and expose the filling.',
    'Place the khachapuri on the hot baking sheets/pizza stone and bake for 10 minutes or until golden brown on top.',
    'Crack the eggs inside the rim on each khachapuri and bake for further 3 minutes or until egg white is cooked and yolk is runny.',
    'Brush the khachapuri with melted garlic butter and serve.'
  ]
+++
