+++
title = 'Spinach and Asparagus Risotto'
date = '2017-04-05'
author = 'Marica'
...
[recipe]
  ...
  description = 'An Italian-inspired risotto with fresh Spring produce'
  yield = 'Serves 2'
  ...
  instructions = [
    'Bring a bring pot of water to boil over high heat. Put the spinach leaves in the boiling water and let them cook for 30-60 seconds until they turn bright in colour. Remove from the water and place them in your blenders smoothie cup. Squeeze the excess water out but leave just the right amount to have a smooth puree once the leaves are blended. Set the spinach puree aside.',
