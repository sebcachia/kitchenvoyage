+++
title = 'Spinach, Mushroom and Kimchi Pies'
date = '2017-04-26'
author = 'Marica'
...
[recipe]
  ...
  instructions = [
    ...
    'Transfer the cabbage to a colander, rinse it properly under cold water and let it drain.',
    'In the meantime, in a small bowl mix together the garlic, ginger, sugar, fish sauce and gochugaru. This should form like a paste.',
    'Gently squeeze the cabbage to remove any excess water and return to a clean bowl. You can use the same bowl you used before but make sure you rinse it well from the salt water.',
    'Add the radish, spring onions and paste to the cabbage and mix all ingredients together, preferably using your hands, until all vegetables are well coated with the paste.',
    'Transfer the kimchi into jars and press down the vegetables. Leave at least 1 inch on top.',
    'Seal the jar and let it stand at room temperature for a maximum of 5 days. Make sure that once a day you press down the vegetables to keep them submerged under the water.',
    'You may use the kimchi right away at this point but it is better if you transfer it to the fridge and let it ferment there slowly for another week or so.'
  ]
+++
...
[recipe title="Spinach, Mushroom and Kimchi Pies" servings="18-20 mini pies" time="2hr 30mins" difficulty="easy" image="http://www.kitchenvoyage.com/wp-content/uploads/2017/04/kimchipies_inside.jpg" description="Mini pies which are great to share during this picnic season."]
[recipe-ingredients]
- Shortcrust pastry (I followed the recipe [here](/recipes/shortcrust-pastry/))
