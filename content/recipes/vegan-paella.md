...
[recipe]
  name = 'Vegan Paella'
  description = 'A vegan twist on the Spanish dish'
  yield = 'Serves 2'
  totalTime = '1hr'
  difficulty = 'easy'
...
Last year, I posted the recipe for a [Chicken and Prawn Paella](/recipes/chicken-prawn-paella/). I have prepared this on several occasions, both as a weeknight dinner and also to serve it when we have guests over. It is always a great go-to dish, and with a bottle of wine... it's just perfect! :D
