...
[recipe]
  ...
  description = 'A classic pesto sauce made with fresh basil, pine nuts and cheese.'
  yield = 'Serves 3-4'
  totalTime = '10mins'
  difficulty = 'easy'
  ...
  instructions = [
    'In a food processor, combine the basil, roasted pine nuts, cheese, garlic, salt and pepper. Pulse several times. Scrape down the sides.',
    'While the food processor is running, slowly add the olive oil. If it is too thick, add another tablespoon of olive at a time to reach your desired consistency. Check the seasoning and adjust accordingly.',
    'Toss with pasta, add to your salad dressing or spread on toasted bread.'
  ]
+++
