...
[recipe]
  ...
  description = 'Hearty balls of lentils to accompany a simple tomato pasta dish'
  yield = 'Serves 2'
  totalTime = '60mins'
  difficulty = 'easy'
...
However, if you want something different, you can flavour the lentil balls with other spices/herbs. I do sometimes use this recipe as a base and instead of the Italian herbs, I use garam masala powder, crushed coriander seeds, minced ginger and turmeric powder for an Indian twist. I would serve these with a [chunky curry sauce](/recipes/lentils-pancakes/) and [homemade naan bread](/recipes/red-lentil-curry-homemade-naan-bread/).
For more lentil recipes, check the link [here](/tag/lentils/).
Bon apetit! :)
